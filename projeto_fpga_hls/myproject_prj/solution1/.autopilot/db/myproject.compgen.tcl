...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { input_layer { I 128 vector } input_layer_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { layer8_out_3 { O 16 vector } layer8_out_3_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { layer8_out_4 { O 16 vector } layer8_out_4_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { layer8_out_5 { O 16 vector } layer8_out_5_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { layer8_out_6 { O 16 vector } layer8_out_6_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { layer8_out_7 { O 16 vector } layer8_out_7_ap_vld { O 1 bit } } \
} "
}
