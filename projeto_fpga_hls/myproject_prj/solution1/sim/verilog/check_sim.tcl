...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.myproject.autotvin_input_layer.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.myproject.autotvout_layer8_out_0.dat"
         "rtl.myproject.autotvout_layer8_out_1.dat"
         "rtl.myproject.autotvout_layer8_out_2.dat"
         "rtl.myproject.autotvout_layer8_out_3.dat"
         "rtl.myproject.autotvout_layer8_out_4.dat"
         "rtl.myproject.autotvout_layer8_out_5.dat"
         "rtl.myproject.autotvout_layer8_out_6.dat"
         "rtl.myproject.autotvout_layer8_out_7.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
